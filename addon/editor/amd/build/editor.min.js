...
// Built from src/editor.js. No minifier is available in this checkout, so this
// AMD module is a hand-wrapped (unminified) build. Keep it in sync with the src.
define('guidanceaddon_editor/editor', ['exports', 'core/ajax', 'core/notification', 'core/str'], function(_exports, _ajax, _notification, _str) {
    'use strict';
    ...
    const Ajax = _interop(_ajax).default;
    const Notification = _interop(_notification).default;
    const getStrings = _str.getStrings;
